...
if (shoppingCartItemCountNotZero) {
    'go to basket'
    WebUI.enhancedClick(findTestObject('GlobalObjects/basket_Icon'), FailureHandling.OPTIONAL)
...
GlobalVariable.pt_ccs_qr = WebUI.getText(findTestObject('ThankYouPage/thankYouPage_orderNumber'))
