...
WebUI.setText(findTestObject('PaymentGateway/WhiteLabel (TH Only)/whiteLabelPayment__creditCardName'), GlobalVariable.visa_cardName)

WebUI.setText(findTestObject('PaymentGateway/WhiteLabel (TH Only)/whiteLabelPayment_cardNo'), GlobalVariable.visa_cardNo, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('PaymentGateway/WhiteLabel (TH Only)/whiteLabelPayment_expiryDate'), GlobalVariable.visa_expiryDate, 
    FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('PaymentGateway/WhiteLabel (TH Only)/whiteLabelPayment_cvv'), GlobalVariable.visa_cvv)
...
WebUI.setText(findTestObject('PaymentGateway/KasikornBank (TH Only)/kasikornBank_otpField'), GlobalVariable.visa_otp)
...
GlobalVariable.pt_ccs_visa = WebUI.getText(findTestObject('ThankYouPage/thankYouPage_orderNumber'))
