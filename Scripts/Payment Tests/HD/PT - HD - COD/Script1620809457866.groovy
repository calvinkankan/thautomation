...
WebUI.enhancedClick(findTestObject('Checkout/Payment Method/checkout_cashOnDeliveryBtn'))
...
GlobalVariable.pt_hd_cod = WebUI.getText(findTestObject('ThankYouPage/thankYouPage_orderNumber'))
