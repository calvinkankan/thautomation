...
//'check cart total should be 9'
//WebUI.verifyElementText(findTestObject('GlobalObjects/basket_ItemCount'), '9')
'go to basket'
WebUI.enhancedClick(findTestObject('GlobalObjects/basket_Icon'))

WebUI.focus(findTestObject('Basket/Delivery Method/basket_hdOption'))
...
WebUI.enhancedClick(findTestObject('K_PaymentGateway (TH Only)/kPaymentGateway_qrSubmitBtn'))

WebUI.enhancedClick(findTestObject('K_PaymentGateway (TH Only)/kPaymentGateway_qrPayBtn'))
...
GlobalVariable.pt_hd_qr = WebUI.getText(findTestObject('ThankYouPage/thankYouPage_orderNumber'))
